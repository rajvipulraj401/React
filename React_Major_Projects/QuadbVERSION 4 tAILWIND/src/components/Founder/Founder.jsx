  ...
  return (
    <div className="container mx-auto flex w-full mt-28">
      ...
      >
        ...
        <div className="">
          <div
            className="line  line1 absolute h-px w-full top-[31%] left-[-400px] lg:top-[19%]  lg:left-[-440px] xllg:top-[18%] xllg:left-[-500px]"
            style={{
              backgroundImage:
          ...
          ></div>
          <div
            className="line line2 absolute h-px w-full lg:w-[88%] top-[33%] left-[-340px] lg:top-[26%] lg:left-[-380px]  xllg:top-[23%] xllg:left-[-420px] bottom-[90%] z-10"
            style={{
              backgroundImage:
                "linear-gradient(to left, #00aa008d 0%, #f2f60090 50%, #ffffff86 100%)",
              // Other styles for your div
...
const FounderSmDown = ({ windowWidth }) => {
  return (
    <div className="container mx-auto flex flex-col  px-3  sm0:px-4 ">
      ...
      <div className="image-container relative w-full mt-4  ">
        <img
          src={baldman}
          alt="Bald Man"
