...
const PremiumPartners = () => {
  ...
  return (
    ...
    >
      ...
      <div className={`absolute left-[-60%] bottom-0 rounded-full h-full blur-lg opacity-50 ${isHovered ? 'opacity-70' : ''} w-full pointer-events-none`} style={{
      ...
      <div className={`absolute right-[-63%] bottom-0 rounded-full h-full blur-lg opacity-50 ${isHovered ? 'opacity-70' : ''} w-full pointer-events-none`} style={{
