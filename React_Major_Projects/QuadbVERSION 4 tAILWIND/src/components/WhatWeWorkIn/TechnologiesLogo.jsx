                ...
                <div className="relative">
                    <div className="">
                        ...
                        <div className={`${isHovered ? 'flex':'hidden'} animate-flicker `}>
                            ...
                            {/* <div className=" absolute left-[79.5%] translate-x-[-50%] top-[13%] rotate-47 h-3 blur-[10px]" style={glowingLineStylesout}></div> */}
                            {/* <div className=" absolute left-[80%] translate-x-[-50%] top-[13%] rotate-47 h-4 blur-[5px]" style={glowingLineStylesout}></div> */}
                            {/* <div className=" absolute left-[80%] translate-x-[-50%] top-[13%] rotate-47 h-6 blur-[2px]" style={glowingLineStylesout}></div> */}
                            <div className="mix-blend-lighten blur-xs w-full flex flex-col justify-center items-center h-[50%] bg-yellow-300 absolute top-[-10%] left-[50%] translate-x-[-50%]" style={{...fixedFade,
                            position: 'absolute',}}>
                        ...
                        {/* <div className="w-full h-full relative mix-blend-lighten">
                            <div className="w-[1728px] h-[776.89px] left-[0px] top-[0px] absolute">
                                <div className="w-[776.89px] h-[864px] left-[0px] top-[776.89px] absolute rotate-90" style={styles}></div> 
                                <div className="w-[776.89px] h-[864px] left-[1728px] top-[776.89px] absolute -rotate-90" style={styles2}></div>
                            </div>
