...
const TeamsMdUp = ({ isInView, windowWidth }) => {
  ...
  return (
    <div className="container mx-auto ContainerDivofTeam flex flex-row w-full pl-10 h-screen text-white">
      <div className="sm:px-0 px-0 relative md:bottom-[-25px] lg:bottom-[100px] xl:bottom-[-30px] w-[50%] lg:w-[60%] xl:w-[60%] flex flex-col justify-start lg:justify-center">
        ...
        <p className="lg:text-[18px] leading-8 font-normal text-[14px] md:text-[14px]  md2:text-[16px]  w-full">
      ...
      <div className="fULLCONTAINER xl:px-8 lg:px-6 px-3 flex flex-nowrap flex-col w-full h-full">
