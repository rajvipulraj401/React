...
//         }}
//       />
//       <div className="flex flex-col items-center w-full pt-10 bg-linear-to-r from-neutral-950 from-10% via-neutral-900 via-35% to-neutral-950 to-80%">
...
//           <div className="mdUp-leftText text-white h-[200px] 2xl:w-full xl:w-[75%] lg:w-full">
...
//             <div className="my-2 h-px bg-white flex justify-between align-middle mx-auto lg:w-[75%] xl:w-[75%]">
...
//         }}
//       />
//       <div className="py-4 px-7 flex flex-col items-center w-full bg-linear-to-r from-neutral-950 from-10% via-neutral-900 via-35% to-neutral-950 to-80%">
  ...
  return (
    <div className="relative mt-24 overflow-hidden">
      ...
      <div className="flex flex-col items-center w-full pt-10 bg-linear-to-r from-neutral-950 from-10% via-neutral-900 via-35% to-neutral-950 to-80%">
        ...
        <div className="mdUp-leftTextRightIMg flex  lg:flex-row lg:justify-between  xl:justify-center 2xl:w-full lg:w-full lg:pb-10">
          {/* <div className="mdUp-leftText text-white h-[200px] 2xl:w-full xl:w-[55%] lg:w-[100% ]"> */}
          <div className="mdUp-leftText text-white h-[180px] lg:h-[200px]  relative lg:right-0 mlg:right-[50px] mdg:right-[0px] right-[-20px]">
            ...
            {/* <div className="my-2 h-px bg-white flex justify-between align-middle mx-auto lg:w-[62%] xlg:w-[64%] xl:w-[67%]  xl2:w-[69%] xxl:w-[70%]  2xl:w-[68%] "> */}
            <div className="my-2 h-px bg-white flex justify-between align-middle mx-auto lg:w-[73.5%] ">
    ...
    <div className="relative py-[0px]">
      ...
      <div className="py-4 px-7 flex flex-col items-center w-full bg-linear-to-r from-neutral-950 from-10% via-neutral-900 via-35% to-neutral-950 to-80%">
        <div className="ImgandHeading flex pb-7 w-full justify-center flex-col items-center py-7">
          ...
          {/* Logo Img ends here */}
          <p className="font-nephilm w-full sm:w-[98%]  md1:w-[95%] text-white font-normal text-[14px] sm:text-[14px] text-center mt-4">
            From
            ...
            <div className="flex   sm1:ml-3  md1:ml-24 sm:pr-5 md1:pr-16 sm:ml-10 dxs:w-full w-[88vw]">
              <div className="text-white flex    flex-col sm:items-center items-start list-none w-full">
                <div className="w-full flex flex-col   flex-wrap ">
                  ...
                  <li>
                    <p className="font-nephilm font-thin  mt-7 text-[14px] sm0:text-[16px] w-full sm0:w-[90%] sm2:w-[68%] sm:w-[60%] ">
