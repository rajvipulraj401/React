  ...
  return (
    <>
      ...
      <div
        ...
        id="blogs"
      >
        <div className="grid grid-cols-3 grid-rows-3 gap-3  w-[95%] md:w-[88%] lg:w-[78%] xl:w-[58%] h-screen mt-24">
  ...
  return (
    <>
      ...
      >
        ...
        {/* <div className="grid grid-cols-2 grid-rows-4 gap-3 w-[58%] h-screen"> */}
